...
#define WILDRIVER_DIMENSION_TYPE uint64_t
#endif
...
int wildriver_load_matrix(wildriver_matrix_handle* handle,
                          wildriver_ind_t* rowptr, wildriver_dim_t* rowind,
                          wildriver_val_t* rowval, double* progress);
...
int wildriver_save_matrix(wildriver_matrix_handle* handle,
                          ...
                          wildriver_val_t const* rowval, double* progress);
 ...
 */
int wildriver_load_graph(wildriver_graph_handle* handle, wildriver_ind_t* xadj,
                         wildriver_dim_t* adjncy, wildriver_val_t* vwgt,
                         wildriver_val_t* adjwgt, double* progress);
...
int wildriver_load_vector(wildriver_vector_handle* handle,
                          wildriver_val_t* vals, double* progress);
...
int wildriver_save_vector(wildriver_vector_handle* handle,
                          wildriver_val_t const* vals, double* progress);
 ...
 */
int wildriver_read_matrix(char const* fname, wildriver_dim_t* r_nrows,
                          wildriver_dim_t* r_ncols, wildriver_ind_t* r_nnz,
 ...
 * @return 1 on success, 0 otherwise.
 */
int wildriver_write_matrix(char const* fname, wildriver_dim_t nrows,
                           wildriver_dim_t ncols, wildriver_ind_t nnz,
                           wildriver_ind_t const* rowptr,
                           wildriver_dim_t const* rowind,
 ...
 * @return 1 on success, 0 otherwise.
 */
int wildriver_read_graph(char const* fname, wildriver_dim_t* r_nvtxs,
                         wildriver_ind_t* r_nedges, int* r_nvwgts, int* r_ewgts,
                         wildriver_ind_t** r_xadj, wildriver_dim_t** r_adjncy,
                         wildriver_val_t** r_vwgt, wildriver_val_t** r_adjwgt);
 ...
 * @return 1 on success, 0 otherwise.
 */
int wildriver_write_graph(char const* fname, wildriver_dim_t nvtxs,
                          wildriver_ind_t nedges, int nvwgts,
