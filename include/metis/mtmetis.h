...
int MTMETIS_PartGraphRecursive(
    mtmetis_vtx_type const* nvtxs, mtmetis_vtx_type const* ncon,
    mtmetis_adj_type const* xadj, mtmetis_vtx_type const* adjncy,
    mtmetis_wgt_type const* vwgt, mtmetis_vtx_type const* vsize,
    mtmetis_wgt_type const* adjwgt, mtmetis_pid_type const* nparts,
    mtmetis_real_type const* tpwgts, mtmetis_real_type const* ubvec,
    double const* options, mtmetis_wgt_type* r_edgecut,
 ...
 */
int MTMETIS_NodeND(mtmetis_vtx_type const* nvtxs, mtmetis_adj_type const* xadj,
                   mtmetis_vtx_type const* adjncy, mtmetis_wgt_type const* vwgt,
                   double const* options, mtmetis_pid_type* perm,
...
int MTMETIS_ComputeVertexSeparator(
    mtmetis_vtx_type const* nvtxs, mtmetis_adj_type const* xadj,
    mtmetis_vtx_type const* adjncy, mtmetis_wgt_type const* vwgt,
    double const* options, mtmetis_wgt_type* sepsize, mtmetis_pid_type* where);
...
int mtmetis_partition_explicit(mtmetis_vtx_type nvtxs,
                               ...
                               double const* options, mtmetis_pid_type* where,
