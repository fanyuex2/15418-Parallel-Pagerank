...
int main(int argc, char** argv) {
    ...
    g = snap_load_graph(argv[1]);
    // printf("Checking graph stats...\n");
    // printf("----------incoming start idx--------\n");
    // for (int i = 0; i < g->num_nodes + 1; i++) {
    //     std::cerr << g->incoming_starts[i] << ' ';
    // }
    // std::cerr << std::endl;
    // printf("----------incoming edges in vertex order--------\n");
    // for (int i = 0; i < g->num_edges; i++) {
    //     std::cerr << g->incoming_edges[i] << ' ';
    // }
    // std::cerr << std::endl;
    // printf("----------num of outgoing edges per vertex--------\n");
    // for (int i = 0; i < g->num_nodes; i++) {
    //     std::cerr << g->outgoing_count << ' ';
    // }
    // std::cerr << std::endl;

    // if (USE_BINARY_GRAPH) {
    //     std::cerr << "Hello, using binary mode" << "\n";
